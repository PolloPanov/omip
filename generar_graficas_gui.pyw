...
def ejecutar(args):
    try:
        ...
        messagebox.showinfo("OMIP", "La generación de la gráfica se ha iniciado.\n\nLa gráfica se guardará en la carpeta graficas_historicas y se enviará a Telegram.")
...
root.configure(padx=30, pady=25)
 ...
 tk_title = tk.Label(root, text="GRÁFICAS HISTÓRICAS OMIP", font=("Segoe UI", 20, "bold"))
tk_title.pack(pady=(0, 8))

subtitle = tk.Label(root, text="Elige qué gráfica quieres generar", font=("Segoe UI", 11))
subtitle.pack(pady=(0, 25))

btn30 = tk.Button(root, text="Últimos 30 días", command=ultimos_30, font=("Segoe UI", 16, "bold"), height=2, width=28)
btn30.pack(pady=10)

btnmes = tk.Button(root, text="Mes concreto", command=mes_concreto, font=("Segoe UI", 16, "bold"), height=2, width=28)
btnmes.pack(pady=10)

footer = tk.Label(root, text="Las gráficas se guardan y se envían a Telegram", font=("Segoe UI", 9))
